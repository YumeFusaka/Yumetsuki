...
当前实现仍以 PySide6 为主 UI。Tauri UI 重构设计已定稿，目标为 Tauri shell + Vue3 组合式 + Pinia + TypeScript 前端，Python 作为 headless sidecar；该目标尚未实施，不能把目标架构描述为已落地。
