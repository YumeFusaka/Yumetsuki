...
Yumetsuki 是一个 Python 桌宠 AI 伴侣项目，第四阶段已完成，第五阶段核心能力和改进实现已基本完成，第六阶段核心能力已完成本地自动化验证，当前进入真实浏览器、OCR、MCP 与语音服务联调。
...
- 第六阶段：核心实现已完成，等待真实浏览器 / OCR / MCP 环境联调
  ...
  - OCR 与视觉输入已接入：新增 `vision/` 模块，支持 Tesseract OCR、显式读屏触发和 `SessionContext.visual_observations` 注入。
...
- 继续推进真实环境联调：
  ...
  - 真实 Playwright Edge 持续会话、真实 Tesseract OCR、第三方 MCP 服务端联调
...
- [Phase 6：浏览器、视觉与插件生态设计](./docs/superpowers/specs/2026-05-24-phase-6-browser-vision-ecosystem-design.md)
- [Phase 6 插件 / MCP 诊断实施计划](./docs/superpowers/plans/2026-05-26-phase-6-plugin-mcp-diagnostics-implementation.md)
- [Phase 6 浏览器持续会话实施计划](./docs/superpowers/plans/2026-05-26-phase-6-browser-session-implementation.md)
- [Phase 6 OCR 与视觉输入实施计划](./docs/superpowers/plans/2026-05-26-phase-6-ocr-vision-implementation.md)
