...
Yumetsuki（梦月）是一个 Python 桌宠 AI 伴侣项目，第三阶段已完成，当前已进入 Phase 4 实施阶段。
...
- [SessionContext 与首字热路径设计](./superpowers/specs/2026-05-24-session-context-hot-path-design.md)
  Phase 4 的详细短期记忆与热路径设计
- [EventBus 与线程治理设计](./superpowers/specs/2026-05-24-eventbus-threading-design.md)
  Phase 4 的事件边界与主线程分发设计
- [TTS 稳定性与有界流水线设计](./superpowers/specs/2026-05-24-tts-stability-pipeline-design.md)
  Phase 4 的 TTS 稳定性与并发治理设计
- [Phase 4 后半段收口实施计划](./superpowers/plans/2026-05-24-phase-4-back-half-closure-implementation.md)
  基于当前真实进度继续收口 EventBus / TTS / 文档与验证
...
- 第四阶段：已完成路线图设计，待进入实施
  ...
  - 待继续收口：
    ...
    - TTS 句段生命周期、取消语义、总超时与队列上限
    - Phase 4 最终验证与实现级文档同步
- 第五阶段：已确认范围，暂未展开实施计划
  - 桌宠体验与交互输入输出
  - 系统设置 / 聊天界面优化
  - STT 接入
...
3. `docs/superpowers/specs/2026-05-24-session-context-hot-path-design.md`
4. `docs/superpowers/plans/2026-05-24-phase-4-back-half-closure-implementation.md`
