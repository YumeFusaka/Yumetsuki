...
- [Web 自动化插件设计](./superpowers/specs/2026-05-22-web-automation-plugin-design.md)
- [Web 自动化实现计划](./superpowers/plans/2026-05-22-web-automation-plugin.md)
...
- Web 自动化插件（搜索、提取文本、截图）— 已有设计和计划，待实现
